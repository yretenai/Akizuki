...
// Original Port at
// https://github.com/ValveResourceFormat/ValveResourceFormat/blob/fd9bc105378040d9e0726f45dbb3b1d657d383de/ValveResourceFormat/Compression/MeshOptimizerVertexDecoder.cs
...
public static partial class MeshOptimizerVertexDecoder {
	...
	private static byte Unzigzag8(byte v) => (byte) (-(v & 1) ^ (v >> 1));
	...
	public static void DecodeVertexBuffer(int vertexCount, int vertexSize, Span<byte> buffer, Span<byte> result, bool useSimd = true) {
